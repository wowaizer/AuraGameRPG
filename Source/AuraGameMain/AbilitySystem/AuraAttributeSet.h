 ...
 */
UCLASS()
class AURAGAMEMAIN_API UAuraAttributeSet : public UAttributeSet
{
	GENERATED_BODY()
...
public:
	...
	//TBaseStaticDelegateInstance<FGameplayAttribute(),FDefaultDelegateUserPolicy>::FFuncPtr FuncionPointer;
	/*
	**
     Primary Attributes
	*/
