...
#include "AuraGameMain/AI/AuraAIController.h"
...
void AAuraEnemy::HitReactTagChanged(const FGameplayTag TagChange, int32 NewCount)
{
...
void AAuraEnemy::HitReaction_Implementation(bool IsHit)
{
	if(IsHit)
	{
...
void AAuraEnemy::OnOwnerTagChange(FGameplayTag TagChange, int32 NewCount)
{
	bHitReacting = NewCount > 0;
	GetCharacterMovement()->MaxWalkSpeed = bHitReacting ? 0.f : BaseWalkSpeed;
}
